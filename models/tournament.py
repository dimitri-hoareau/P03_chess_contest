...
class Tournament:
    ...
    def add_turns_to_tournament(self,turn, tournaments_table, tournament_id):
        ...
        for match in turn_matches:
            # print(match.match[0][0])
            # print(match.match[0][0].last_name)
            # print(match.match[0][0].first_name)
            # print(match.match[0][0].last_name + " " + match.match[0][0].first_name + " (" + str(match.match[0][0].id) + ")")
            serialiazed_match = {
